...
{   
    ...
    Eigen::Vector3f ab(_v[1].x() - _v[0].x(), _v[1].y() - _v[0].y(),1.0f);
    Eigen::Vector3f bc(_v[2].x() - _v[1].x(), _v[2].y() - _v[1].y(), 1.0f);
    Eigen::Vector3f ca(_v[0].x() - _v[2].x(), _v[0].y() - _v[2].y(), 1.0f);
    ...
    if ( ab_ap.z()>0.f && bc_bp.z()>0.f && ca_cp.z()>0.f )
    {
        return true;
    }
    if ( ab_ap.z()<0.f && bc_bp.z()<0.f && ca_cp.z()<0.f )
